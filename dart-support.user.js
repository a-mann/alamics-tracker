...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__taskHeaderDesign_js__ = __webpack_require__(26);
...
switch (action_page) {
    ...
    case 'red':
        ...
        __WEBPACK_IMPORTED_MODULE_13__taskHeaderDesign_js__["a" /* taskHeaderDesign */]();
        break;
    case 'user_page':
        __WEBPACK_IMPORTED_MODULE_1__addCSSSelectors_js__["a" /* addPageElems */]();
        __WEBPACK_IMPORTED_MODULE_4__goToTask_js__["a" /* goToTaskDatalist */]();
...
function dataMaining() {
    ...
    let source = {};
    const taskHead = __WEBPACK_IMPORTED_MODULE_0__finders_js__["f" /* getTaskHead */]();

    source.task = {
        'title': taskHead.title,
        'id': __WEBPACK_IMPORTED_MODULE_0__finders_js__["g" /* getTaskId */](),
